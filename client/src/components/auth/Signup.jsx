...
class Signup extends Component {
  ...
  onSubmit = async (dispatch, e) => {
    ...
    try {
      ...
      //const myDecodedToken = decodeToken(newUser.data)
      localStorage.setItem("auth-token", newUser.data.token);
      localStorage.setItem("userId", newUser.data.savedUser._id);
      localStorage.setItem("userrole", newUser.data.savedUser.role);
