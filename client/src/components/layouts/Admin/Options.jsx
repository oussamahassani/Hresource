...
console.log(newTeam)
  ...
  addToGoogleCalender = (e) => {
    ...
    try {
      ...
      console.log(gapi);
      var CLIENT_ID = "86740423382-q9mqf1jl75h7r2qkqk1tq1qmvbu1evue.apps.googleusercontent.com"
      //  "487679379915-7rvf2ror46e4bbsj8t8obali4heq5qjm.apps.googleusercontent.com";
      var API_KEY = "AIzaSyAU8H4XUuMcfVBwpNAmAosEGUAZXofgbyI" //"AIzaSyB_HYziuQ7j6s9CiqSgXV3YiGTzr5nc0xE";
      var DISCOVERY_DOCS = [
